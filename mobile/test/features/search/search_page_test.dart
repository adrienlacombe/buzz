...
void main() {
  ...
  testWidgets('renders channel-role bots in message previews', (tester) async {
    ...
    await tester.pumpWidget(
      WidgetHelpers.testable(
        overrides: [
          ...
          userCacheProvider.overrideWith(() => _FakeUserCacheNotifier(agent)),
    ...
    expect(content.mentionNames, const {'agent-pubkey': 'Helper Bot'});
    expect(content.agentMentionPubkeys, contains('agent-pubkey'));
